...
test("findLongestSTring to return the first instance where multiple strings are of the same maximum length", () => {
  expect(
    findLongestString(["Olivia", "Monquie", "Rebecca", "Rose", "Walker"])
  ).toBe("Monquie");
});
